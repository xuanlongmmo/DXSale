<ul class="home__nav-list">
    <li onclick="return ope(this)" id="td1" class="home__nav-item">
        <a href="{{ route('home') }}" class="home__nav-item-link">
            <svg id="svgtd1" id="svg" class="home__nav-item-icon sc-bdVaJa fUuvxv" fill="#757575" width="22px" height="22px" viewBox="0 0 1024 1024" rotate="0"><path d="M512 224l-320 256v416h224v-256h192v256h224v-416l-320-256z M512 128l-192 153.6v-89.6h-128v191.998l-64 50.998 23.020 22.768 360.98-288.784 360.98 288.786 23.020-22.77-384-306.996z"></path></svg>
            <span id="name1" class="home__nav-item-name">Home</span>
        </a>
    </li>
    ...
    <li onclick="return ope(this)" id="td4" class="home__nav-item expanded">
        <div class="home__nav-item-title">
            <span class="home__nav-item-title-desc">
                <svg id="svgtd4"  class="home__nav-item-icon sc-bdVaJa fUuvxv" fill="#757575" width="22px" height="22px" viewBox="0 0 1024 1024" rotate="0"><path d="M928 96c0 0-39.6 2.8-106.2 54.4-31 24-324.4 241.2-324.4 241.2l-319.4-15.8-82 73 204 102.4-16 20.2-163.2 8.2-13.4 67.2 121.2 94.4-53.4 107.2 107.4-53 94.6 121.2 67.2-13.4 8.2-163.2 20.2-15.8 102.4 203.8 73-81.8-15.8-319.4c0 0 217.2-293.4 241.2-324 51.8-67.2 54.4-106.8 54.4-106.8z"></path></svg>
                <span id="name4" class="home__nav-item-name">DxLaunch</span>                                   
            </span> 
            <span id="stt1" class="home__nav-item-title-icon">
                <i id="td4_up" class="home__nav-item-title-icon-item home__nav-item-title-icon-item--up fas fa-chevron-up none"></i> 
                <i id="td4_down" class="home__nav-item-title-icon-item home__nav-item-title-icon-item--down fas fa-chevron-down"></i>
            </span>
        </div>
        <ul id="td4_son" class="home__nav-son none">
            <li class="home__nav-son-item-title">Launchpad</li>
            <li class="home__nav-son-item">
                <a id="defidashboard" href="{{ route('defidashboard') }}" class="home__nav-son-item-link">Dashboard</a>
            </li>
            <li class="home__nav-son-item">
                <a id="deficreatesale" href="{{ route('deficreatesale') }}" class="home__nav-son-item-link">Start or Manage</a>
            </li>
        </ul>
    </li>
    <li onclick="return ope(this)" id="td5" class="home__nav-item expanded">
        <div class="home__nav-item-title">
            <span class="home__nav-item-title-desc">
                <svg id="svgtd5" class="home__nav-item-icon sc-bdVaJa fUuvxv" fill="#757575" width="22px" height="22px" viewBox="0 0 1024 1024" rotate="0"><path d="M605.4 128l-319.4 448h191.6l-59 320 319.4-448h-191.6l59-320z"></path></svg>
                <span id="name5" class="home__nav-item-name">DxFairLaunch</span>
            </span> 
            <span  id="stt2" class="home__nav-item-title-icon">
                <i id="td5_up" class="home__nav-item-title-icon-item home__nav-item-title-icon-item--up fas fa-chevron-up none"></i> 
                <i id="td5_down" class="home__nav-item-title-icon-item home__nav-item-title-icon-item--down fas fa-chevron-down"></i>
            </span>
        </div>
    ...
    <li onclick="return ope(this)" id="td6" class="home__nav-item expanded">
        <div class="home__nav-item-title">
            <span class="home__nav-item-title-desc">
                <svg id="svgtd6" class="home__nav-item-icon sc-bdVaJa fUuvxv" fill="#757575" width="22px" height="22px" viewBox="0 0 1024 1024" rotate="0"><path d="M752 372h-40v-80c0-110-90-200-200-200s-200 90-200 200v80h-40c-44.004 0-80 35.996-80 80v400c0 44.004 35.996 80 80 80h480c44.004 0 80-35.996 80-80v-400c0-44.004-35.996-80-80-80zM512 736c-44.004 0-80-35.996-80-80s35.996-80 80-80 80 35.996 80 80-35.996 80-80 80zM636.004 372h-248.008v-80c0-68.008 56.006-124.004 124.004-124.004 68.008 0 124.004 55.996 124.004 124.004v80z"></path></svg>
                <span id="name6" class="home__nav-item-name">DxLock</span> 
            </span> 
            <span  id="stt3" class="home__nav-item-title-icon">
                <i id="td6_up" class="home__nav-item-title-icon-item home__nav-item-title-icon-item--up fas fa-chevron-up none"></i> 
                <i id="td6_down" class="home__nav-item-title-icon-item home__nav-item-title-icon-item--down fas fa-chevron-down"></i>
            </span>
        </div>
    ...
    <li onclick="return ope(this)" id="td7" class="home__nav-item expanded">
        <div class="home__nav-item-title">
            <span class="home__nav-item-title-desc">
                <svg id="svgtd7" class="home__nav-item-icon sc-bdVaJa fUuvxv" fill="#757575" width="22px" height="22px" viewBox="0 0 1024 1024" rotate="0"><path d="M156.2 411.2c-4.8 0-9.8-1.2-14.2-3.8-13.4-7.8-18-24.8-10.2-38.2 35.6-60 143.8-200.2 380.2-200.2 102.4 0 192.2 27.2 266.8 80.8 61.4 44 95.8 93.8 112.2 117.8 8.8 12.8 5.4 30-7.4 38.8-12.8 8.6-30.4 5.4-39.2-7.4-29.8-43.2-120.2-174.4-332.4-174.4-207.2 0-300.8 120.8-331.4 172.6-5.2 9.2-14.6 14-24.4 14z M631 960c-2.4 0-4.6-0.2-7-0.8-171.4-43-235.4-216.2-238-223.4l-0.4-1.6c-1.4-5-35.8-123.8 17-193.4 24.2-31.8 61-48 109.6-48 45.2 0 77.8 14.2 100.2 43.6 18.4 24 25.8 53.6 33 82.2 15 59.4 25.8 90.6 88.2 93.8 27.4 1.4 45.4-14.8 55.6-28.6 27.6-37.6 32.4-99 11.6-153-26.8-70-121.6-201.8-288.8-201.8-71.4 0-137 23.2-189.6 66.8-43.6 36.2-78.2 87.2-94.8 139.6-30.8 97.6 9.6 251 10 252.4 4 14.8-5 30.2-20 34-15 4-30.6-5-34.6-19.8-1.8-7-45-170.6-9.4-283.4 38.8-122.2 158.4-245.4 338.4-245.4 83.2 0 161.8 28.6 227.4 82.6 50.8 42 92.4 98.4 114 154.8 27.6 72 20.2 152.8-18.8 205.6-26 35.2-63 53.6-104 51.6-106.8-5.4-126-80.8-140-135.8-14.4-56.4-23.6-83.6-78.6-83.6-30.2 0-51.4 8.4-64.6 25.8-18 23.8-19.4 61-17.4 88 2 28.2 8 51 9.4 55.6 4.4 11.2 61.6 153 198.6 187.4 15.2 3.8 24.2 19 20.4 33.8-3.4 12.6-14.8 21-27.4 21z M411 947.2c-7.6 0-15-3-20.6-8.8-68.6-72.8-107.4-154.2-122-256v-0.6c-8.2-67.4 3.8-162.8 62.6-228.4 43.4-48.4 104.4-73 181-73 90.6 0 161.8 42.6 206.2 123 32.2 58.4 38.6 116.6 38.8 119 1.6 15.4-9.8 29-25.2 30.6s-29.4-9.6-31-24.8v0c0-0.6-5.6-50.6-33-99.4-34.4-61.4-86.8-92.6-156-92.6-59.8 0-106.6 18.2-138.8 54.2-46.4 51.8-55.4 131.6-49 184.4 12.8 90 47 161.6 107.4 225.6 10.6 11.2 10 29-1.4 39.4-5.2 4.8-12.2 7.4-19 7.4z M727 867c-60 0-111-16.8-151.8-50.2-82-66.8-91.2-175.6-91.6-180.2-1.2-15.4 10.4-28.8 26-30s29 10.2 30.2 25.6c0.2 1.6 8.4 90.6 71.6 141.8 37.4 30.2 87.4 42.2 149 35.2 15.4-1.8 29.4 9.2 31.2 24.6s-9.4 29.2-24.8 30.8c-13.6 1.6-27 2.4-39.8 2.4z M774.4 125.2c-23.4-15.4-106.4-61.2-262.4-61.2-163.8 0-247 50.6-265.4 63.4-1.2 0.8-2.4 1.6-3.4 2.6-0.2 0.2-0.4 0.2-0.4 0.2v0c-5.8 5.2-9.4 12.6-9.4 20.8 0 15.4 12.6 27.8 28.2 27.8 6.2 0 11.8-2 16.4-5.2v0l-0.2 0.2c0.8-0.6 72.6-54 234.2-54s233.4 53.6 234.2 54l-0.2-0.2 0.4-0.4c4.8 3.6 10.6 5.6 17 5.6 15.6 0 28.2-12.4 28.2-27.8 0-11.6-7-21.6-17.2-25.8z"></path></svg>
                <span id="name7" class="home__nav-item-name">Sercurity</span>
            </span> 
            <span id="stt4" class="home__nav-item-title-icon">
                <i id="td7_up" class="home__nav-item-title-icon-item home__nav-item-title-icon-item--up fas fa-chevron-up none"></i> 
                <i id="td7_down" class="home__nav-item-title-icon-item home__nav-item-title-icon-item--down fas fa-chevron-down"></i>
            </span>
        </div>
    ...
    <li onclick="return ope(this)" id="td8" class="home__nav-item expanded">
        <div class="home__nav-item-title">
            <span class="home__nav-item-title-desc">
                <svg id="svgtd8" class="home__nav-item-icon sc-bdVaJa fUuvxv" fill="#757575" width="22px" height="22px" viewBox="0 0 1024 1024" rotate="0"><path d="M498.4 448c-28.4-80.4-110.2-144-200.4-144-114.4 0-202 93.6-202 208s91.6 208 206 208c90.2 0 168.2-63.6 196.4-144h205.6v128h138.2v-128h85.8v-128h-429.6zM303.2 581c-38 0-69-31-69-69s31-69 69-69 69 31 69 69-31 69-69 69z"></path></svg>
                <span id="name8" class="home__nav-item-name">DxSale DAO</span>
            </span> 
            <span id="stt5" class="home__nav-item-title-icon">
                <i id="td8_up" class="home__nav-item-title-icon-item home__nav-item-title-icon-item--up fas fa-chevron-up none"></i> 
                <i id="td8_down" class="home__nav-item-title-icon-item home__nav-item-title-icon-item--down fas fa-chevron-down"></i>
            </span>
        </div>
    ...
    <li onclick="return ope(this)" id="td9" class="home__nav-item expanded">
        <div class="home__nav-item-title">
            <span class="home__nav-item-title-desc">
                <svg id="svgtd9" class="home__nav-item-icon sc-bdVaJa fUuvxv" fill="#757575" width="22px" height="22px" viewBox="0 0 1024 1024" rotate="0"><path d="M960 256h-896v640h896v-640z M144 192h736v32h-736v-32z M208 128h608v32h-608v-32z"></path></svg>
                <span id="name9" class="home__nav-item-name">Archives</span> 
            </span> 
            <span id="stt6" class="home__nav-item-title-icon">
                <i id="td9_up" class="home__nav-item-title-icon-item home__nav-item-title-icon-item--up fas fa-chevron-up none"></i> 
                <i id="td9_down" class="home__nav-item-title-icon-item home__nav-item-title-icon-item--down fas fa-chevron-down"></i>
            </span>
        </div>
