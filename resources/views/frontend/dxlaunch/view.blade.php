...
<div id="dxdash__thrid__content" class="DxFarilxDash__details">
    {{--  No Login  --}}
    <input type="text" id="checkacc" hidden>
    <div style="margin-top: 40px" id="notloginlogin" style="display: flex" class="DxFarilxDash__active bsd">
        <button onclick="return connectmeta()" class="DxFarilxDash__active-btn btn bgr--blu">Connect Wallet to Start</button>
    ...
    {{--  Login  --}}
    <div style="margin-top: 40px" id="loginlogin" style="display: none" class="home__login-header bsd">
        <div class="home__login-header-item-block">
            <div class="home__login-header-item">
                ...
                <div id="address_meta" class="home__login-header-item-btn btn btn--diss"></div>
            </div>
        </div>
        <div class="home__login-header-item-block">
            <div class="home__login-header-item">
    ...
    <div class="DxFarilxDash__box row">
        <input hidden type="text" id="idtoken" value="{{ $_GET['id'] }}">
        <div class="DxFarilxDash__box-left col-3">
            <div class="DxFarilxDash__box-left-item bsd">
                <p style="font-size: 1.1rem;" class="DxFarilxDash__box-left-item-desc-text">
                    <p style="text-align: center">DxSale Automated Warning System</p><br><br>
                    7 Warnings Detected
            ...
            <div class="DxFarilxDash__box-left-item bsd">
                <div align="center" justify="center">
                    ...
                    <h4 style="font-weight: bold;font-size: 17px;padding-top: 10px;">TokenSniffer Scan</h4><br>
                    <span>Scan Report Not Available.<br>Report Status: nan</span>
                </div>
            </div>
        </div>
            ...
            <div class="DxFairlxDash__box-bet bsd">
                <div class="DxFarilxDash__box-header DxFairlxDash__box-bet-item--mbm">
                    ...
                    <div class="DxFarilxDash__box-header-desc">
                        <h2 class="DxFairlxDash__box-bet-item-name blu-hot-h2">{{ $dxlaunch->token_name }}</h2>
                ...
                <div class="DxFairlxDash__box-bet-item">
                    <div class="DxFairlxDash__box-bet-item-desc">
                        <div class="DxFairlxDash__box-bet-item-desc-text">
                            Token Address: <a style="text-decoration: underline" href="https://etherscan.io/address/{{ $dxlaunch->token }}">{{ $dxlaunch->token }}</a>
                        ...
                        <div style="display: none" id="formamount" class="DxFairlxDash__box-bet-item-btn-block">
                            <input class="omginput" type="text" id="amount" placeholder="Enter the number of tokens you want to buy!">
                        </div>
                        ...
                        @if ($dxlaunch->soft > $dxlaunch->sumamount() && (strtotime($dxlaunch->end) - strtotime($date) > 0))
                            <div class="DxFairlxDash__box-bet-item-btn-block">
                                ...
                                <button onclick="return showinput()" id="btn__buy" class="DxFairlxDash__box-bet-item-btn btn bgr--blu">
                                    Buy Token
                                </button>
                            </div>
                        @elseif (strtotime($dxlaunch->end) - strtotime($date) <= 0)
                            <div class="DxFairlxDash__box-bet-item-btn-block">
                                <button style="background-color: rgb(79 75 84 / 39%)" class="DxFairlxDash__box-bet-item-btn btn dao-bgr--pur">
                                    Token sold out
                                </button>
                            </div>
                        @endif
                ...
                <div class="DxFairlxDash__box-bet-item">
                    <div style="text-align: center;width: 40%;margin: 20px auto;padding: 20px;border-radius: 10px;box-shadow: 0px 1px 8px 0px rgb(80 80 80 / 20%), 0px 3px 4px 0px rgb(80 80 80 / 14%), 0px 3px 3px -2px rgb(80 80 80">
                        <span style="font-size: 12px">Your Contributed Amount:<br><span id="amountbuy">{{ $dxlaunch->sumamountacc('0xAA3b504a05cDD461867eda44Eb618e26C116D55C') }}</span> TOKEN</span>
                    </div>
                </div>
