                    ...
                    <div id="DxFarilxStart__import__1__banner" class="DxFarilxStart__import-item active">
                        ...
                        <div id="DxFarilxStart__import__1__son" class="DxFarilxStart__import-son ">
                            <div class="DxFarilxStart__import-son-group">
                                ...
                                <input name="token" id="token" type="text" class="DxFarilxStart__import-son-input" placeholder="Ex. 0x">
                    ...
                    <div id="DxFarilxStart__import__2__banner" class="DxFarilxStart__import-item active">
                        ...
                        <div id="DxFarilxStart__import__2__son" class="DxFarilxStart__import-son none">
                            <div class="DxFarilxStart__import-son-group">
                                ...
                                <input id="price" name="price" type="text" class="DxFarilxStart__import-son-input" placeholder="Ex. 500">
                                <div class="DxFarilxStart__import-son-ac">
                        ...
                        <div id="DxFarilxStart__import__3__son" class="DxFarilxStart__import-son none">
                            ...
                            <div class="DxFarilxStart__import-son-group-block">
                                <div class="DxFarilxStart__import-son-group">
                                    ...
                                    <input name="soft" id="soft" type="text" class="DxFarilxStart__import-son-input" placeholder="Soft Cap ex. 20">
                                </div>
                                <div class="DxFarilxStart__import-son-group">
                                    <label for="" class="DxFarilxStart__import-son-label">Hard Cap:</label>
                                    <input id="hard" name="hard" type="text" class="DxFarilxStart__import-son-input" placeholder="Hard Cap ex. 100">
                                </div>                                       
                            </div>
                            <div class="DxFarilxStart__import-son-ac">
                        ...
                        <div id="DxFarilxStart__import__4__son" class="DxFarilxStart__import-son none">
                            ...
                            <div class="DxFarilxStart__import-son-group-block">
                                <div class="DxFarilxStart__import-son-group">
                                    ...
                                    <input id="min" name="min" type="text" class="DxFarilxStart__import-son-input" placeholder="Minimum contribution Ex. 0.1">
                                </div>
                                <div class="DxFarilxStart__import-son-group">
                                    <label for="" class="DxFarilxStart__import-son-label">Maximum Contribution Limit:</label>
                                    <input id="max" name="max" type="text" class="DxFarilxStart__import-son-input" placeholder="Maximum contribution Ex. 10">
                                </div>                                       
                            </div>
                            <div class="DxFarilxStart__import-son-ac">
                    ...
                    <div id="DxFarilxStart__import__5__banner" class="DxFarilxStart__import-item active">
                        ...
                        <div id="DxFarilxStart__import__5__son" class="DxFarilxStart__import-son none">
                            <div class="DxFarilxStart__import-son-group">
                                ...
                                <input id="liquidity" name="liquidity" type="text" class="DxFarilxStart__import-son-input" placeholder="Ex. 60">
                                <div class="DxFarilxStart__import-son-ac">
                    ...
                    <div id="DxFarilxStart__import__7__banner" class="DxFarilxStart__import-item active">
                        ...
                        <div id="DxFarilxStart__import__7__son" class="DxFarilxStart__import-son none">
                            ...
                            <div class="DxFarilxStart__import-son-group">
                                ...
                                <input id="logo_link" name="logo_link" type="text" class="DxFarilxStart__import-son-input" placeholder="https://dxsale.network/assets/media/logoIcon_256.png">
                            </div>
                            <div class="DxFarilxStart__import-son-group">
                                <label for="" class="DxFarilxStart__import-son-label no-mb">Website Link:</label>
                                <input id="website_link" name="website_link" type="text" class="DxFarilxStart__import-son-input" placeholder="https://dxsale.network">
                            </div>
                            <div class="DxFarilxStart__import-son-group">
                                <label for="" class="DxFarilxStart__import-son-label no-mb">Github Link:</label>
                                <input id="github_link" name="github_link" type="text" class="DxFarilxStart__import-son-input" placeholder="https://github.com/OpenZeppelin/openzeppelin-contracts">
                            </div>
                            <div class="DxFarilxStart__import-son-group">
                                <label for="" class="DxFarilxStart__import-son-label no-mb">Twitter Link:</label>
                                <input id="twitter_link" name="twitter_link" type="text" class="DxFarilxStart__import-son-input" placeholder="https://twitter.com/dxsale">
                            </div>
                            <div class="DxFarilxStart__import-son-group">
                                <label for="" class="DxFarilxStart__import-son-label no-mb">Reddit Link:</label>
                                <input id="reddit_link" name="reddit_link" type="text" class="DxFarilxStart__import-son-input" placeholder="https://reddit.com/r/cryptocurrency">
                            </div>
                            <div class="DxFarilxStart__import-son-group">
                                <label for="" class="DxFarilxStart__import-son-label no-mb">Telegram Link:</label>
                                <input id="telegram_link" name="telegram_link" type="text" class="DxFarilxStart__import-son-input" placeholder="https://t.me/dxsale">
                            </div>
                            <div class="DxFarilxStart__import-son-group">
                                <label for="" class="DxFarilxStart__import-son-label no-mb">Project Description:</label>
                                <input id="description" name="description" type="text" class="DxFarilxStart__import-son-input" placeholder="DxSale is a completely decentralized and permissionless launchpad with instant Listing and liquidity locking!">
                            </div>
                            <div class="DxFarilxStart__import-son-group">
                        ...
                        <div id="DxFarilxStart__import__8__son" class="DxFarilxStart__import-son none">
                            ...
                            <div class="DxFarilxStart__import-son-group-block">
                                ...
                                <div class="DxFarilxStart__import-son-group">
                                    ...
                                    <input name="start" id="start" value="{{ $date }}" type="datetime-local" class="DxFarilxStart__import-son-input" placeholder="Minimum contribution Ex. 0.1">
                                </div>
                                <div class="DxFarilxStart__import-son-group">
                                    <input name="end" id="end" value="{{ $date }}" type="datetime-local" class="DxFarilxStart__import-son-input" placeholder="Maximum contribution Ex. 10">
                                </div>                                       
                            </div>
                            <div class="DxFarilxStart__import-son-title">Liquidity Lockup Time</div>
                            <div class="DxFarilxStart__import-son-group-block">
                                <div class="DxFarilxStart__import-son-group half">
                                    <input name="lock" id="lock" value="{{ $date }}" type="datetime-local" class="DxFarilxStart__import-son-input" placeholder="Minimum contribution Ex. 0.1">
                                </div>
                            </div>
                            <div class="DxFarilxStart__import-son-ac">
