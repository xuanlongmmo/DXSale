        ...
        <div class="DxMint">
            <div class="DxMint__header bsd bsd--b">
                <div class="DxFarilxDash__find-header">
                    ...
                    <h2 class="DxFarilxDash__find-header-title">KYC Panel - Submit KYC Details</h2>
                </div>
                <h3 class="active__tab-title">Submit KYC Data for a specific wallet.</h3>
                    ...
                    <div class="DxMint__body-create bsd bsd--bold col-lg-8 offset-lg-2 col-12">
                        <div class="custom-select--desc box__desc">
                            ...
                            <ul class="box__desc-list">
                                ...
                                <li class="box__desc-item">
                                    Start by entering the wallet address of the user being KYCed
                                </li>
                                <li class="box__desc-item">
                                    Enter the region or country they are based out of
                                </li>
                                <li class="box__desc-item">
                                    Enter a link where users/law officials can report this wallet or request information
                                </li>
                            </ul>
                        </div>
